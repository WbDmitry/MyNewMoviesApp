...
import com.example.mynewmoviesapp.model.rest_entites.ListMoviesDTO
import com.example.mynewmoviesapp.model.rest_entites.MovieDTO
...
object MovieLoader {
    ...
    fun loadListNewMovies(): ListMoviesDTO? {
        try {
            val uri =
                URL("https://api.themoviedb.org/3/movie/now_playing?api_key=$API_KEY&language=ru")
            lateinit var urlConnection: HttpsURLConnection
            try {
                urlConnection = uri.openConnection() as HttpsURLConnection
                urlConnection.requestMethod = "GET"
